...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/mark/Desktop/programs/python_programs/tax_project/tax_server'
    let bin = 'local/bin'
    let path_sep = ':'
...
alias deactivate = source '/home/mark/Desktop/programs/python_programs/tax_project/tax_server/local/bin/deactivate.nu'
